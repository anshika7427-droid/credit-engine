    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-vapor-card border border-vapor-border max-w-lg w-full p-6 space-y-4 shadow-2xl">
            <div className="flex items-start justify-between gap-3 border-b border-vapor-border pb-3">
              <div>
                <span className="font-mono text-[10px] uppercase tracking-widest text-steel-muted">
                  [ STATUTORY POLICY FLOOR ]
                </span>
                <h3 className="text-base font-bold text-steel-ink m-0">
            ...
            <div className="space-y-2 text-xs text-steel-muted leading-relaxed">
              <p>
              ...
              <div className="p-3 bg-vapor-canvas border border-vapor-border font-mono text-[11px] space-y-1 text-steel-ink">
                <div className="flex items-center gap-1.5 text-steel-ink font-bold mb-1">
                  <Info className="w-3.5 h-3.5 text-steel-primary" />
            ...
            <div className="pt-2 flex justify-end">
              <button
                onClick={() => setShowModal(false)}
                className="px-4 py-2 text-xs font-mono font-bold bg-steel-ink hover:bg-steel-primary text-white transition-colors cursor-pointer uppercase"
              >
                DISMISS
              </button>
            </div>
